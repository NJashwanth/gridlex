...
class StorageSource {
  ...
  Future<String> saveImageToStorage(MedicalFormModel medicalFormModel) async {
    ...
    UploadTask uploadTask = storageReference
        .child(medicalFormModel.healthCareContactInformationModel.designation +
            " " +
            medicalFormModel
                .healthCareContactInformationModel.requestorFirstName)
        .putFile(file);
    await uploadTask;
